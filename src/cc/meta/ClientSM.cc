//---------------------------------------------------------- -*- Mode: C++ -*-
// $Id: ClientSM.cc 71 2008-07-07 15:49:14Z sriramsrao $
//
// Created 2006/06/05
// Author: Sriram Rao
//
...
/// 由一个NetConnection创建一个clientSM, 用于和该Client通信
...
///
/// 向client发送回复信息, 这个信息由MetaRequest生成
void ClientSM::SendResponse(MetaRequest *op)
{
	ostringstream os;

	// 由MetaRequest生成对client的回复信息
	op->response(os);
...
///
/// 处理用户发送的请求: EVENT_NET_READ, EVENT_NET_WROTE, EVENT_CMD_DONE,
/// EVENT_NET_ERROR.
...
///
void ClientSM::HandleClientCmd(IOBuffer *iobuf, int cmdLen)
{
