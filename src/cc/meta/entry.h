 ...
 * processing is to split the line into its component parts, then
 ...
 */
extern bool pop_name(string &name, const string tag, deque<string> &c, bool ok);
extern bool pop_path(string &path, const string tag, deque<string> &c, bool ok);
...
extern bool pop_type(FileType &t, const string tag, deque<string> &c, bool ok);
extern bool pop_time(struct timeval &tv, const string tag, deque<string> &c,
		bool ok);
