//---------------------------------------------------------- -*- Mode: C++ -*-
// $Id: metaserver_main.cc 153 2008-09-17 19:08:16Z sriramsrao $
//
// Created 2006/03/22
// Author: Blake Lewis
//
...
int main(int argc, char **argv)
{
	...
	// 5. 启动网络相关进程: client, chunkserver, 定时器, 分发器.
...
int ReadMetaServerProperties(char *fileName)
{
	...
	{
		cout << "Aborting...bad chunk server port: " << gChunkServerPort
				<< endl;
		return -1;
	}
	...
	cout << "min. # of chunkserver that should connect: " << gMinChunkservers
			<< endl;
